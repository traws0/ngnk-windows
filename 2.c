...
S A3(___f,Nn=yn,i=!x;I(i,x=get(y,0))W(i<n,x=z2(x,get(y,i++));B(!x))y(x))
...
S A3(___s,Nn=yn,i=!x;Au;I(i,x=get(y,0);u=enl(xR))E(u=oA)W(i<n,x=z2(x,get(y,i++));B(!x)uq(xR))I(x,x(0))y(u))
S A3(dexs,x?x(y):y)
S A3(mxms,
