...
S A pen2(A x,A y,I f)_(P(xta&&yta,A u=gkv(&y);amd(A_(x,y,cv(f),u),4))P(xtaAX||ytaAX,eac(cv(f),A_(x,y),2))
 ...
 xr;yr;A u=atn(d&&f<8?tD:xtiI?tI:tL,k==2?xn:yn);
 P(k==1,P(xtdD,D a=gd_(x);arD(f,un,D b=ydi;udi=)u)
        P(xtlL,L a=gl_(x);arL(f,un,L b=yli;uli=)u)
               I a=gi (x);arI(f,un,L b=yii;uii=)u)
 P(k==2,P(xtdD,D b=gd_(y);arD(f,un,D a=xdi;udi=)u)
        P(xtlL,L b=gl_(y);arL(f,un,L a=xli;uli=)u)
               I b=gi (y);arI(f,un,I a=xii;uii=)u)
 P(xn-yn,el())
 P(xtdD,arD(f,un,D a=xdi;D b=ydi;udi=)u)
 P(xtlL,arL(f,un,L a=xli;L b=yli;uli=)u)
        arI(f,un,I a=xii;I b=yii;uii=)u)
