...
let kwasm,app,mem,heap,inp='',strace=0;const env={},fd=Array(8/*[{p:path,o:offset}]*/),fs={/*{path:U8(content)}*/js:U8([])},
...
X('write',(f,a,n)=>{if(f<3){ap(t0(M(a,n)));return n}f=fd[f];BADF(!f);let{p,o}=f,r=n;a=M(a,n)
 if(p==='js')a=t1(JSON.stringify(eval(t0(a)))||null)
 ;(fs[p]=rsz(fs[p],max(fs[p].n,o+a.n))).set(a,o);f.o=p==='js'?0:f.o+a.n;return r})
