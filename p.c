...
S A0(pIL,A x=aL(0);C c;W(1,L l=pl(&s);c=*s;$(!l&&c=='N',l=_0N;c=*++s)x=apv(x,&l);$(c-32||!num(s+1),B)c=*++s)c=='i'?s++,N(gI(x)):c=='j'?s++,x:x)
...
S A pSs(C d)_(A x=aS(0);W(1,I v=sym(d-'`'||*s-'"'?pS(&s):pC());x=apv(x,&v);P(*s-d,x)++s)0)
