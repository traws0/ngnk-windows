...
NI I eS(Ax/*1*/,Ii)_(Y(!e.s,e.s=x;e.o=i)E(x(0))0)
A3(try,x=apn(x,y);P(x,z(x))
 Y(ztF,Ck=na(z);z=k==1?ap1(z,aCn(e.m,e.n)):k==2?apn(z,a2(aCn(e.m,e.n),a2(e.s?_R(e.s):ac(0),az(e.o)))):z)eC();z)
A1(epr,I h=64;C s0[3*h+Z(e.m)+6],*s=s0;*s++='\'';Mc(s,e.m,e.n);s+=e.n;*s++=10;
 Y(e.s,Ax=e.s;C*t=xC+e.o,*p=t,*q=t+1;W(p>xC&&p>t-h&&p[-1]&&p[-1]-10,p--)W(q<xC+xn&&q<=t+h&&*q&&*q-10,q++)
  Mc(s,p,q-p);Y(p<=t-h,*s=s[1]='.')Y(q>t+h,s[q-p-2]=s[q-p-1]='.')s+=q-p;*s++=10;Ms(s,32,t-p);s+=t-p;*s++='^';*s++=10)
