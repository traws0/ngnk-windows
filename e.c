...
NI A e0(O C*m)_(Y((UL)m<256,m=(C*[]){eM}[(I)m])e.n=min(mn(m),Z(e.m)-1);mc(e.m,m,e.n);e.m[e.n]=0;0)
NI A e1(O C*m,A x)_(dex(x,e0(m)))NI A e2(O C*m,A x,A y)_(dex(y,e1(m,x)))NI A e3(O C*m,A x,A y,A z)_(dex(z,e2(m,x,y)))
NI A errn(O C*m,I n,O A*a)_(mrn(n,a);e0(m))NI S I ecl()_(e.n=0;Y(e.s,mr(e.s);e.s=0)e.o=0)NI I eso(A x/*1*/,I o)_(Y(!e.s,e.s=x;e.o=o)0)
