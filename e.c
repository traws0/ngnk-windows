...
S C m[32];S I n,o;A s; //message,length,offset,source
...
SN I eC()_(n=0;I(s,mr(s);s=0)o=0)
NI I eS(Ax/*1*/,Ii)_(P(s,x(0))s=x;o=i;0)
A3(try,x=apn(x,y);P(x,z(x))I(ztF&&zK<3,Ay=aCn(m,n);z=zK<2?ap1(z,y):apn(z,a2(y,a2(s?_R(s):oC,az(o)))))eC();z)
A1(epr,I h=64;Cb[3*h+6+SZ m],*r=b;*r++='\'';Mc(r,m,n);r+=n;*r++=10;
 I(s,Ax=s;C*t=xV+o,*p=t,*q=t;W(p>xC&&p>t-h&&p[-1]&&p[-1]-10,p--)W(q<xC+xn&&q<=t+h&&*q&&*q-10,q++)
