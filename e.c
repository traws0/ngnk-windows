...
A3(try,x=apn(x,y);P(x,z(x))
 I(ztF,Ik=zK;z=k==1?ap1(z,aCn(e.m,e.n)):k==2?apn(z,a2(aCn(e.m,e.n),a2(e.s?_R(e.s):ac(0),az(e.o)))):z)eC();z)
A1(epr,I h=64;C s0[3*h+6+SZ e.m],*s=s0;*s++='\'';Mc(s,e.m,e.n);s+=e.n;*s++=10;
