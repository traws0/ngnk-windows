...
SN A2(eac1,/*10*/Yu(eac1f(x,v1[yv]))Xt(y1(x))Xm(eacm(y,&x,1))
 ...
 Au=0;i(m,Az=y1(t==2?xa:ii(x,i));B(!z,I(u,u=u(0))I(t==2,mrn(m-i-1,xA+i+1)))I(!u,u=atn0(z,m))uq(z))x(u))
...
SN A3(eac2,/*110*/P(ztv,eac2f(x,y,v2[zv]))Xt(Yt(z2(x,y))ear2(x,y,z))Yt(eal2(x,y,z))Xm(eacm(z,A(x,y),2))Ym(eacm(z,A(x,y),2))
 ...
 i(m,A v=z2(t==2?xa:ii(x,i),s==2?ya:ii(y,i));B(!v,I(u,u=u(0))I(t==2,mrn(m-i-1,xA+i+1))I(s==2,mrn(m-i-1,yA+i+1)))
  I(!u,u=atn0(v,m))uq(v))
