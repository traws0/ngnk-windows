...
AX(rdc,XzZ(AXA2(x,a,n,dec))XcC(AXA2(x,a,n,join))P(xk<2,cvg(x,a,n))
 ...
 Y(n==1&&xtv&&xv<8&&(!y||ytt)&&c3(tC,zt,tD),Y(zt<tH,z=gH(z))Y(y,N(sup(&y,&z)))
  P(ztZ,Lv=gl(y?y:get(z,0));m2(z,((int(*)(V*,V*,L))arr[zt-tH][xv])(&v,zC+ZT[zt]*!y,m-!y));az(v))
  P(ztD,Dv=gd(y?y:get(z,0));m2(z,((int(*)(V*,V*,L))arr[zt-tH][xv])(&v,zC+ZT[zt]*!y,m-!y));ad(v)))
