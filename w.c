...
AX(rdc,P(xtilIL,n>1?ern(n,a):K("{z+x*y}/[0;;]",xR,*a))P(xtcC,join(x,a,n))P(Ak(x)<=1,cvg(x,a,n))
 ...
 Y(xtv&&Av(x)<8&&(!y||ytt)&&n==1,Y(ztC,z=gL(z);P(!z,Y(y,yr);0))Y(y&&ytdD||ztdD,Y(y,y=gD(y))z=gD(z))
  P(ztI,I*p=zi,a=!y?m--,*p++:gi(y);mr2(z,a=((int      (*)(I,I*,L))arf[0][Av(x)-1][3])(a,p,m));ai(a))
  P(ztL,L*p=zl,a=!y?m--,*p++:gl(y);mr2(z,a=((long long(*)(L,L*,L))arf[1][Av(x)-1][3])(a,p,m));al(a))
  P(ztD,D*p=zd,a=!y?m--,*p++:gd(y);mr2(z,a=((double   (*)(D,D*,L))arf[2][Av(x)-1][3])(a,p,m));ad(a)))
...
AX(scn,P(xtilIL,enc(x,a,n))P(xtcC,spl(x,a,n))P(Ak(x)<=1,cvi(x,a,n))
 P(n==1,A z=*a;P(ztt||!zn,z)P(zta,z=mut(z);zy=scn(x,&zy,1);z)P(x==cv(','),scn(x,A_(a0(),z),2))
  Y(xtv&&Av(x)<8,Y(ztC,z=N(gL(z)))
   P(ztI,A u=ax(z);I a=*ui=*zi;((void(*)(I,I*,I*,L))arf[0][Av(x)-1][4])(a,zi+1,ui+1,zn-1);u)
   P(ztL,A u=ax(z);L a=*ul=*zl;((void(*)(L,L*,L*,L))arf[1][Av(x)-1][4])(a,zl+1,ul+1,zn-1);u)
   P(ztD,A u=ax(z);D a=*ud=*zd;((void(*)(D,D*,D*,L))arf[2][Av(x)-1][4])(a,zd+1,ud+1,zn-1);u))
