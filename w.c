...
A eac2(Ax/*1*/,Ay/*1*/,Az/*0*/)_(eac(z,A(x,y),2))
...
AX(rdc,Y(n==1,XzZ(dec(xR,*a))Xc(jc(gi(x),*a))XC(jC(xC,xn,*a)))P(na(x)<2,cvg(x,a,n))
...
AX(scn,Y(n==1,XzZ(enc(xR,*a))Xc(splc(gi(x),*a))XC(splC(xC,xn,*a)))P(na(x)<2,cvi(x,a,n))
