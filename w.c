...
AX(rdc,P(xtilIL,n>1?ern(n,a):K("{z+x*y}/[0;;]",xR,*a))P(xtcC,join(x,a,n))P(Ak(x)<=1,cvg(x,a,n))
 ...
 Y(xtv&&Av(x)<8&&(!y||ytt)&&n==1,Y(ztC,z=gL(z);P(!z,Y(y,yr);0))Y(y&&ytdD||ztdD,Y(y,y=gD(y))z=gD(z))
  P(ztI,I*p=zi,a=!y?m--,*p++:gi(y);mr2(z,ai(((int      (*)(I,I*,L))arf[0][Av(x)-1][3])(a,p,m))))
  P(ztL,L*p=zl,a=!y?m--,*p++:gl(y);mr2(z,al(((long long(*)(L,L*,L))arf[1][Av(x)-1][3])(a,p,m))))
  P(ztD,D*p=zd,a=!y?m--,*p++:gd(y);mr2(z,ad(((double   (*)(D,D*,L))arf[2][Av(x)-1][3])(a,p,m)))))
