...
A splcC(Cc,C*p,Ln)_(C*q=p,*t=p+n,*r=t;Ax=oA;W(q<r,Y(*q-c,q++)E(xq(aCm(p,q));p=q+=1))Y(c-10||p<t,xq(aCm(p,t)))x)
...
AX(scn,XzZ(AX2(enc))Y(n==1,Xc(splc(gi(x),*a))XC(splC(xC,xn,*a)))P(xk<2,cvi(x,a,n))
