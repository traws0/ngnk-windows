...
AX(ear,P(n==1,dec(x,a,n))P(n-2,enn(n,a))x=prj(x,A_(*a,av_plc  ),n);dex(x,eac(x,a+1,1)))
AX(eal,P(n==1,enc(x,a,n))P(n-2,enn(n,a))x=prj(x,A_(av_plc,a[1]),n);dex(x,eac(x,a  ,1)))
