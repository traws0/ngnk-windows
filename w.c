...
SN A3(fld2,/*110*/Yt(z2(x,y))P(ztv&&zv<11&&xtzdc&&ytZDC,arf(x,y,z))i(yN,x=z2(x,get(y,i));B(!x))y(x))
A2(fld1,/*10*/Xt(x)P(ytv&&yv<11&&xtZDC,arf(0,x,y))P(!xN,x(id_(y,x)))Az=get(x,0);i(xN-1,z=y2(z,get(x,i+1));B(!z))x(z))
...
SN A2(scn1,/*10*/Xt(x)P(!xN,x)Xm(Az=kv(&x);am(x,Nx(scn1(z,y))))P(y==CAT,scn2(oA,x,y))P(ytv&&yv&&yv<11&&xtZDC,ars(0,x,y))
