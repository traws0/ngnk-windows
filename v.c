...
A1(unq,!xtT?et(x):xn<2?x:K("{x@&@[&#x;i;:;]@[;0;:;a=a:*a]@a:~$[`X=@x;~;=]':x@i:<x}",x))
...
S L DL(D v)_(*(L*)&v)
S V cstci(O C*RE a,I*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,r),r[i]=a[i]))
S V cstic(O I*RE a,C*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,a),r[i]=a[i]))
S V cstlc(O L*RE a,C*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,a),r[i]=a[i]))
S V cstil(O I*RE a,L*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,r),r[i]=a[i]==_0Ni?_0Nl:a[i]))
S V cstli(O L*RE a,I*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,a),r[i]=a[i]==_0Nl?_0Ni:a[i]))
S V cstld(O L*RE a,D*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,a),r[i]=a[i]==_0Nl?_0n :a[i]))
S V cstdl(O D*RE a,L*RE r,UL n)_(ALN(a)ALN(r)F(PAD(n,a),r[i]=a[i]==_0n ?_0Nl:a[i]))
