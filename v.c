...
til_(L)til_(I)til_(H)rev_(C)rev_(I)rev_(L)c_(C,I,r)c_(I,C,a)c_(L,C,a)cN(I,L,r)cN(L,I,a)cN(L,D,a)cN(D,L,a)
...
A1(typ,C t=xt;xr;as(syC(TS[t])))A1(len,dex(x,al(len_(x))))L len_(A x/*0*/)_(xtT?xn:xtm?len_(xy):!xtM?1:An(xy)?len_(*(A*)dat(xy)):1)
