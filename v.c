...
c_(C,I,r)c_(H,I,r)c_(I,C,a)c_(I,H,a)c_(L,C,a)cN(I,L,r)cN(L,I,a)cN(L,D,a)cN(D,L,a)
...
A1(til,P(xtl,Ln=gl(x);I m=n<0;n*=1-2*m;Au=aL(n);tilL(ul,n);m?sub(u,al(n)):u)
       P(xti,In=gi(x);I m=n<0;n*=1-2*m;Au=aI(n);tilI(ui,n);m?sub(u,ai(n)):u)
       P(xth,Hn=gh(x);I m=n<0;n*=1-2*m;Au=aH(n);tilH(uh,n);m?sub(u,ah(n)):u)
