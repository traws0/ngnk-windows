...
A1(unq,P(!xtT,et(x))A u=atn(xt,0);I w=tz(xt);P(w==ZR,F(xn,fndpa(&u,mR(xai)))xr;u)
                                             P(w==0,F(xn,fndpc(&u,xci))xr;u)
                                             P(w==2,F(xn,fndpi(&u,xii))xr;u)
                                             P(w==3,F(xn,fndpl(&u,xli))xr;u)UR;0)
...
A2(cst,P(ytaAX,eac(cV('$'),A_(x,y),2))P(xts,C*s=C(symstr(gs(x))),c=*s*!s[1];c=='c'?gC(y):c=='i'?gI(y):c=='j'?gL(y):c=='f'?gD(y):en(y))
