...
I mtc_(Ax,Ay/*x0y0*/)_(P(x==y,1)P(xt-yt&&c3(tH,xt,tL)&&c3(tH,yt,tL)&&xn==yn,gl(K("*/=",xR,yR)))
 P(xt-yt||pkd(x)||(xtr&&xv-yv)||xn-yn,0)P(!ref(x),i(xn*ZT[xt],P(xc-yc,0))1)i(xn,P(!mtc_(xa,ya),0))1)
