...
S V cstli(O L*a,I*r,UL n)_(F(n,r[i]=a[i]==_0Nl?_0Ni:a[i]))S V cstic(O I *a,C*r,UL n)_(F(n,r[i]=a[i]))
S V cstld(O L*a,D*r,UL n)_(F(n,r[i]=a[i]==_0Nl?_0n :a[i]))S V cstlc(O L *a,C*r,UL n)_(F(n,r[i]=a[i]))
