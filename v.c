...
A1(flp,P(xtaA,Y(xta,A y=xy;P(!ytX||!yn,er(x))F(yn,A z=yai;P(!ztT,en(x)))L m=An(*ya);F(yn,A z=yai;P(zn-m,el(x))))AT(xt^ta^tA,x))
 P(xtt,enl(enl(x)))K("{$[(`X=@x)&#x;(,/n#'x)(n*!#x)+/:!n:|/#'x;,x]}",x))
