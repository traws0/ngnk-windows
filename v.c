...
A wdn(Ax,Ni,Nj,Nn)_(Ct=xt;Q(c3(tC,t,tI));Ay=atn(t+1,n);x2(CH(t-tC,&cCH,cBH,cHI,cIL,cLD)(xC+ZT[t]*i,yC,j-i);y))
...
L tru(Ax/*1*/)_(Lv=c3(tc,xt,ts)?gl_(x):xtF?!xtu||xv:xn;x(0);v)
