...
A1(til,P(xtX,xn?ed(x):x)P(xto,val(x))P(xta,fir(AT(tX,x)))P(xtIL,K("{x((*a)#&#)'1_a:|*\\|x,1}",x))P(xti,K("`i$!`l$",x))
 P(xtl,L n=gl_(x);n<0&&n-_0Nl?add(x,N(till(-n))):till(gl(x)))P(!xtL,et(x))en(x))
