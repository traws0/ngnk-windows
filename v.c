...
#define cN(Ta,Tr,pd)  S V c##Ta##Tr(O Ta*RE a,Tr*RE r,UL n)_(F(PAD(n,pd),r[i]=a[i]==N##Ta?N##Tr:a[i]))
til_(L)til_(I)til_(H)rev_(C)rev_(I)rev_(L)c__(C,I,r)c__(I,C,a)c__(L,C,a)cN(I,L,r)cN(L,I,a)cN(L,D,a)cN(D,L,a)
