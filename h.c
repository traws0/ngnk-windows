...
S A insL(Ax,Li,Ln,Ay)_(
 Xmt(et2(x,y))
 Ymt(insL(x,i,n,enl(y)))
 P(xtM||ytM,en2(x,y))
 P(xtZ&&ytZ&&xt-yt,V(f,cT[max(xt,yt)])insL(f(x),i,n,f(y)))
 P(xt-yt,insL(cA(x),i,n,cA(y)))
...
S A3(ins3,Yz(insL(x,gl(y),0,z))YZ(P(yN-2,el2(x,z(y)))Ln=gl(ii(y,1));insL(x,gl(fir(y)),n,z))et2(x,z(y)))
