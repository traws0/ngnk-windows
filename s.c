...
S V shr3(UL*x,I d){F(2,x[i]=x[i]>>d|x[i+1]<<(64-d))x[2]>>=d;}S V ash3(UL*x,I d){UL y[3];mc(y,x,24);shr3(y,d);UL c=0;F(3,x[i]=addcll(x[i],y[i],c,&c));}
SN V pows5(UL(*a)[2],I n,UL x0,UL x1,UL x2){UL x[]={x0,x1,x2};F(n,mc(a+i,x+1,16);ash3(x,2);$(x[2]>>61,shr3(x,1)))}
SN V init(){pows5(I5,NI5,0xebd5cf2016a52921,0x4ac7ca59a424c507,0x9558b4661b6565f8);I5[NI5-1][0]=0;I5[NI5-1][1]=1ll<<61;pows5(P5,NP5,0,0,1ll<<61);}
...
S C*sd(C*s,L f)_(UL x=f;UL m=x<<12>>12;I e=x<<1>>53;P(m&&e==2047,MC(s,"0n"))$(x>>63,*s++='-')P(e==2047,MC(s,"0w"))m|=(UL)!!e<<52;e+=!e-1075;
 P(!m||(e<1&&e>-53&&mp2(m,-e)),MC(sX(s,m>>-e),".0"))e-=2;UL u;I t;I ev=!(m&1);UI h=m<<12||e<-1075;UL v,w;I u0=0,w0=0;m<<=2;$(!I5[1][0],init())
