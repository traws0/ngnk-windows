...
// github.com/ulfjack/ryu (apache2|boost license)
 ...
 S UL mult(UL a,UL b,UL*rh)_(UI al=a,ah=a>>32,bl=b,bh=b>>32;UL c=(UL)al*bl;UL u=(UI)(c>>32)+(UL)ah*bl,v=(UI)u+(UL)al*bh;
...
S V shr3(UL*x,UL*y,I d){F(2,x[i]=y[i]>>d|y[i+1]<<(64-d))x[2]=y[2]>>d;}
S V pws5(UL(*a)[2],I n,L u,L v,L w){UL x[]={u,v,w},y[3],c;F(n,mc(a+i,x+1,16);shr3(y,x,2);c=0;F(3,x[i]=addcll(x[i],y[i],c,&c))$(x[2]>>61,shr3(x,x,1)))}
SN V init(){pws5(I5,P5-I5,0xebd5cf2016a52921,0x4ac7ca59a424c507,0x9558b4661b6565f8);P5[0][0]=0;P5[0][1]=1ll<<61;pws5(P5,I5+ZZ(I5)-P5,0,0,1ll<<61);}
...
S C*sd(C*s,L f)_(UL x=f;UL m=x<<12>>12;I e=x<<1>>53;P(m&&e==2047,MC(s,"0n"))$(x>>63,*s++='-')P(e==2047,MC(s,"0w"))m|=(UL)!!e<<52;e+=!e-1075;
 P(!m||(e<1&&e>-53&&mp2(m,-e)),MC(sX(s,m>>-e),".0"))e-=2;UL u;I t,ev=!(m&1),h=m<<12||e<-1075,u0=0,w0=0;UL v,w;m<<=2;$(!I5[1][0],init())
