...
A1(kst,P(x==au_plc,aC(0))P(xts,x=str(x);C*s=xc;mr(pS(&s));cat(ac('`'),*s?kst(xn-1?x:fir(x)):x))
 K("{kl:{$[|/`X`C=t:@x;1=#x;|/`I`L`D`S=t;2>#x;|/`A`a`q`r`u`v`w=t]{0x28,x,0x29}/`k@x};" //parenthesized as left arg
    ...
    "$[(|/`X`C`I`L`D`S=t:@x)&1=n:#x;0x2c,kr@*x;"
      ...
      "|/`C`c=t;$[&/(</x</:32 127)|~^(e:0x00090a0d225c)?x;0x22,(,/((0x5c,'0x30746e72225c),x)(e,x)?x),0x22;\"0x\",,/+\"0123456789abcdef\"@16 16\\x];"
      "|/`I`i=t;(`k@`l$x),\"i\";"
      "`S=t;$[n;,/`k'x;\"0#`\"];"
      "`A=t;0x2b,`k@+x;"
      "|/`l`d=t;$x;"
      ...
      "`q=t;,/`k'.:x;"
      "`r=t;,/(ka;$:)@'.:x;"
      "|/`u`v=t;\":+-*%!&|<>=~,^#_$?@.0123456789\"[i],((`u=t)+19<i:.:x)#0x3a;"
      "`w=t;0x272f5c[3!i],(2<i:.:x)#0x3a;"
      "n;0x20/`k'x;"
      "`D=t;\"0#0n\";"
      "`L=t;\"!0\";"
      "\"???\"]}",x))
