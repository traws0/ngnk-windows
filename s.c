...
A1(str,P(xtl||xtd,I l=xtl;Lv=gl(x);Au=aC(24);AN((l?sl:sd)(uC,v)-uC,u))P(xts,Iv=gs(x);aCz(syp(&v)))
...
A1(kst,K("{p:{[a;b;c;x]$[|/a=t:@x;1=#x;|/b=t;2>#x;|/c=t]{0x28,x,0x29}/`k@x};" //p:parenthesize
 ...
 "$[(|/`A`C`H`I`L`D`S=t:@x)&1=n:#x;0x2c,r@*x;`A=t;(0x28,0x3b/o'x),0x29;"
   ...
   "|/`H`I=t;$[n;(0x20/$`l$x);\"!0\"],_$t;`L=t;$[n;0x20/$x;\"!0\"];`D=t;$[n;0x20/$x;\"0#0n\"];`S=t;$[n;,/o'x;\"0#`\"];"
   "`M=t;0x2b,o@+x;`m=t;l[!x],0x21,r@.:x;|/`h`i=t;($x),_$t;|/`l`d=t;$x;"
   "`s=t;0x60,$[*/-1/0x303a415b617b>\\:a:$x;a;(0x3a=*a)*/-1/0x2e3a415b617b>\\:1_a;a;(1=#a)_o@a];"
