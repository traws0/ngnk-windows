...
A aCn(Qs,Nn)_(atnv(tC,n,s))A aCm(Qp,Qq)_(aCn(p,q-p))A aCz(Qs)_(aCn(s,sn(s)))A aCl(Qs)_(Qq=mh(s,10);q?aCm(s,q):aCz(s))
...
I syP(Qs)_(In=sn(s)+1;P(n<6,Lv=0;mc(&v,s,n);v)Qp=s0+1;W(p<s1,P(!strcmp(p,s),s0-p)p+=sn(p)+1)
