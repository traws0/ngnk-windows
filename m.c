...
S A mb(Cb,Ax)_(xX=0;xr=0;dbg(AN(-1,AT(0,x)));xU=b;x)V mrn(In,OA*a){i(n,mr(a[i]))}A1(mRa,i(xn,mR(xa))x)
...
A atn(Ct,Nn)_(Q(!lck);Q(c3(tA,t,tn-1));Q(!_P(t));Cb=59-__builtin_clzll(ZA|ZA-1+n*ZT[t]);P(n>1ull<<ZZ(u)||b>ZZ(u)-2,oom())
...
V kf(O char*s,L(*f)(L)){Ax=dmd(A(as(syP(s)),oA,av0,AT(te,AK(1,(A)f))),4);Y(x,x(0))}
