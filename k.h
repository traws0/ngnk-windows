...
A1 a1,asc,ax,blw,cmd,cpl,dsc,enl,enla,fir,flp,flr,gD,gI,gL,gS,grp,hcl,hop,json,las,ldf,len,mr,mRa,mut,neg,not,nul,out,prs,rev,sqr,sys,sqz,str,str0,til,
...
V mrn(L,O A*),*mc(V*,O V*,L),mz(V*,L);I memcmp(O V*,O V*,L),sym(A),ecl(),epr(),eso(A,L),Ci(O C*,C);
