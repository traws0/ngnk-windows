...
A1(js0,Et(!xtcC,x)x=str0(enla(x));s=xV;Ay=jv();I(y&&*s,y=y(0))P(!y,eS(x,s-xC);ep0())x(y))

A1(js1,Xd(str(x))XC(xn-1?kst(x):kst(fir(x)))Xc(js1(enl(x)))XzZ(js1(cD(x)))XMT(sur('[',jc(',',N(eac1(x,js1))),']'))
