...
S A0(js,s++;Ax=aC0;W(1,C*t=s;Cc=*s++;W(c-'"'&&c-'\\'&&c>31,c=*s++)P(c<32,s--;x(0))x=catc(x,t,s-1-t);P(c=='"',x)c=*s++;
...
S A jr(OC*t,Lv)_(Cc;W((c=*t++),P(c-*s,0)s++)az(v))S A0(jt,jr("true",1))S A0(jf,jr("false",0))S A0(jN,jr("null",NL))
