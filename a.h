...
A0 aa0;
A1 a1,aes0,aes1,asc,ax,blw,cf,cmd,cmdl,cpl,des,dsc,enl,enla,epr,fir,flp,flr,frk,gB,gD,gH,gI,gL,gS,grp,hcl,hex,hop,
 jsr,jsw,kst,las,len,md5,mr,mr0,mr1,mRa,mut,neg,not,nul,out,prs,rev,sam,sha1,sha256,sha3_256,sin,ser,sqr,sqz,str,str0,
...
extern OV*vf[],*arr[][11],*ars[][11],*arp[][11],*ara[][11];
