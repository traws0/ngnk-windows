...
EX OC Zt[],ZT[];S C At(A);S I _t(Ct)_(t>tm)S I _T(Ct)_(t<tM)S I _z(Ct)_(c3(ti,t,tl))S I _Z(Ct)_(c3(tB,t,tL))
S I _F(Ct)_(t>=to)S I _P(Ct)_(c3(tc,t,ti)||t==ts||c3(tu,t,te))S I _R(Ct)_(Zt[t]==4)
