...
extern OC Zt[],ZT[];S C At(A);                      //type classes F:function,P:packed,Q:simple,R:reference
...
extern A glb,ce[],cn[],ci[4][5];extern OC vc[];extern OV*vf[],*arf[4][11][8];extern L mu;extern A1*ct[];
