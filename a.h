...
A1 a1,asc,ax,blw,cf,cpl,des,dsc,enl,enla,epr,expx,fir,flp,flr,frk,cB,cC,cD,cH,cI,cL,cS,grp,hex,js0,js1,kst,las,len,logx,
 mr,m0,m1,mRa,mut,neg,not,nul,opn,out,prng,prs,rev,sinx,ser,spl,sqr,sqz,str,str0,til,typ,u0c,u1c,unh,unq,val,whr;
