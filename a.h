...
A1 a1,aes0,aes1,asc,ax,blw,cmd,cpl,des,dsc,enl,enla,epr,fir,flp,flr,frk,gD,gH,gI,gL,gS,grp,hcl,hex,hop,jsr,jsw,kst,las,
 ldf,len,md5,mr,mr0,mr1,mRa,mut,neg,not,nul,out,prs,rev,sha1,sha256,sha3_256,sin,ser,sqr,sqz,str,str0,til,typ,
...
extern A glb,ce[],cn[],ci[3][5];extern OC vc[];extern OV*vf[],*arf[3][11][8];extern L mu;extern A1*ct[];
