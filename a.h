...
V init(),mrn(I,OA*),tilH(V*,L),tilI(V*,L),tilL(V*,L);C*syp(I);I si(OC*,I),eso(A,I),mtc_(A,A),syP(OC*);
...
#define es(a...) e_(s,a)
#define ez(a...) e_(z,a)
#define eA h(n,"nyi")h(l,"len")h(t,"typ")h(d,"dom")h(r,"rnk")h(i,"idx")h(p,"prs")h(s,"stk")h(z,"lmt")
