...
S V md5u(U*d,UL n,U*a){S O U k[]={0xd76aa478,0xe8c7b756,0x242070db,0xc1bdceee,0xf57c0faf,0x4787c62a,0xa8304613,0xfd469501,0x698098d8,0x8b44f7af,
...
S V kecp(UL*a){C l=1;F(24,
 {UL b[7]={};F(5,Fj5(b[1+j]^=*a++))*b=b[5];b[6]=b[1];Fj5(b[j]^=rL(b[j+2],1))a-=25;F(5,Fj5(*a++^=b[j]))a-=25;} //θ
 UL b[25];F(25,b[i]=rL(a[i],(C[]){0,1,62,28,27,36,44,6,55,20,3,10,43,25,39,41,45,15,21,8,18,2,61,56,14}[i]))  //ρ
