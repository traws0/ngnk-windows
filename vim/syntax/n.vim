...
sy region  n_ff matchgroup=n_f start="\<\(for\|Fj\=\)(" end=")" contains=@n_x,n_f |sy match n_f "," contained |hi def link n_f function
sy region  n_ii matchgroup=n_i start="\<\(\$\|E\$\=\)(" end=")" contains=@n_x,n_i |sy match n_i "," contained |hi def link n_i type
sy region  n_ww matchgroup=n_w start="\<W("             end=")" contains=@n_x,n_w |sy match n_w "," contained |hi def link n_w n_f
