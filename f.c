...
NO L fndi(A x/*0*/,I v)_(asrt(Zt[xt]==2);F(xn,P(xii==v,i))NL)L fpi(A*p,I v)_(A x=*p;L n=xn,i=fndi(x,v);P(i<0,*p=apv(x,&v);n)i)
NO L fndl(A x/*0*/,L v)_(asrt(Zt[xt]==3);F(xn,P(xli==v,i))NL)L fpl(A*p,L v)_(A x=*p;L n=xn,i=fndl(x,v);P(i<0,*p=apv(x,&v);n)i)
A2(fnd,
