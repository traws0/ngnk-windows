...
A1(prng,P(x==au,aV(tL,4,a))XZ(x=cL(rshN(4,x));Mc(a,xV,SZ a);x(au))
 Xz(UL v=gl(x);I(!v,v=now())i(ZZ(a),v*=6364136223846793005;v+=1442695040888963407;a[i]=v)au)et1(x)) //knuth mmix
...
A2(fnd,
 P(xtT&&!xtA&&!ytmMA,
  P(xtZ&&ytzZ||xt==TT[yt],
   ...
   Az=aL(yn);Ii=Tz[yt];xe(ye(CH(i,&FB,FH,FI,FL)(xV,xn,f,yV,yn,zV);z)))
