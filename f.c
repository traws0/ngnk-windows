...
A rndD(Ln)_(add(az(-1),AT(tD,add(al(1023ll<<52),N(rd(n,1ll<<52))))))
S ALA(rnd,Xz(rd(n,gl(x)))Xc(gC(add(xv-'A'?ac('a'):x,Nx(rd(n,26)))))Xd(mul(x,Nx(rndD(n))))XMT(idx(x,Nx(rd(n,xN))))et1(x))
