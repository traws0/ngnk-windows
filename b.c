...
SN I ig(Iv)_(Li=fI(gk,gn,v);P(i>=0,i)i=gn;P(i-(UC)i,-1)gn=i+1;gk[i]=v;gv[i]=au;i)
...
AX(run,Q(xto)P(n-xk,er8(a,n))S I d;P(++d>1024,es8(a,n))
 ...
 W((c=*b++),
  ...
  J(c>=bi,
   ...
   J(c==bM,A*v=gv+*b++;*s=*v=v2[*b++](*v,*s);B(!*s)_R(*s))
   J(c==bG,Ax=*--s=gv[*b++];B(!x,ev0())xR)
