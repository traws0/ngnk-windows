...
S A vm_(A f/*0*/)_(W(1,UC b=*ip++;Y(b>=bc,*--sp=mR(A(fc)[b&(mxc-1)]))
...
AX(run,asrt(xto);asrt(n==Ak(x));A f=xR;I m=An(fl);P(sp<sp0+m+3,esn(n,a))*--sp=(A)(V*)ip;*--sp=(A)(V*)loc;*--sp=f;ip=data(fb);loc=sp-1;
