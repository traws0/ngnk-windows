...
SN I ig(Iv)_(Ay=gv;Li=fI(gk,yn,v);P(i>=0,i)i=yn;P(i-(UC)i,-1)yn=i+1;gk[i]=v;ya=0;i)
...
AX(run,Q(xto)P(n-xk,er8(a,n))S I d;P(++d>1024,es8(a,n))
 ...
 W((c=*b++),
  ...
  J(c>=bi,
   ...
   I(c==bm,A*v=l+     *b++;*s=*v=v2[*b++](*v,*s);B(!*s)_R(*s))
   J(c==bM,A*v=_A(gv)+*b++;*s=*v=v2[*b++](*v,*s);B(!*s)_R(*s))
