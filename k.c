...
A2(id_/*x0y0*/,S O C t[]={4,0,0,1,1,2,2,3,3,2,4};xtv&&xv<11?mR(ci[ytiI?0:ytdD?2:1][t[xv]]):mkn(fir(yR)))
...
AX(app,P(xtT,xtX?idxX(x,a,n):n-1?ein(n,a):idx_(x,*a))P(xtil,n-1?ern(n,a):wrt(xR,*a))
 P(xts,P(n>1,ern(n,a))L i=gl(K("``j`k`p`t`x`e`md5`sha1`sha256`sha3`sin?",x));En(i<0,*a)
  (A1*[]){ser,json,kst,prs,fnow,frk,fepr,md5,sha1,sha256,sha3_256,sinx}[i](*a))
...
AA(am1,A x=*a,y=a[1],z=a[2];
 ...
 P(n==4&&(xtIL||xtD)&&ytIL&&ztv&&zv<8&&xt==t_lst(At(a[3])),x=mut(x);A u=a[3];I d=utT;u=enla(u);Ei(d&&yn-un,x,y,u)y=gL(y);
  m2(y,m2(u,x?((I(*)(V*,L,L*,L,V*,I))arf[xt-tI][zv][7])(xc,xn,yl,yn,uc,d):1))?x:ei(x))
