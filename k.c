...
AX(app,P(xtT,xtX?idxX(x,a,n):n-1?ein(n,a):idx_(x,*a))P(xtil,n-1?ern(n,a):wrt(xR,*a))
 P(xts,P(n>1,ern(n,a))L i=gl(K("``j`k`p`t`x`e`hex`md5`sha1`sha256`sha3`sin?",x));En(i<0,*a)
  (A1*[]){ser,json,kst,prs,fnow,frk,fepr,hex,md5,sha1,sha256,sha3_256,sinx}[i](*a))
