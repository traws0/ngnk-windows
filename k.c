...
S A valS(I*a,Nn)_(I*k=gk;A*v=gv;Nm=gn;P(!n,i(gn,_R(gv[i]))am(aV(tS,gn,k),aV(tA,gn,gv)))
...
S A*pth(Ax/*1*/)_(Xt(pth(enl(x)))
 Lj=fI(gk,gn,*xI);I(j<0,gk[j=gn]=*xI;gv[gn++]=xn>1?aa0():au)A*p=gv+j;i(xn-1,P(!stp(i,x,&p),(A*)0))x(0);p)
