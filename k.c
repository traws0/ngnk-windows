...
A3(dm3,Nm=yN;P(y==au||!m,z(z1(y(x)  )))P(m==1,am3(x,fir(y),z  ))am8(A(x,fir(y),prj(DOT,A(PLH,drp(1,yR)),2),z  ),4))
A4(dm4,Nm=yN;P(y==au||!m,z(z2(y(x),u)))P(m==1,am4(x,fir(y),z,u))am8(A(x,fir(y),prj(DOT,A(PLH,drp(1,yR)),2),z,u),5))
