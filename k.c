...
S A valS(I*a,Nn)_(I*k=_V(gk);A*v=_V(gv);Nm=_n(gk);P(!n,am(mut(_R(gk)),mut(_R(gv))))
...
S A*pth(Ax/*1*/)_(Xt(pth(enl(x)))
 Lj=fpI(&gk,*xI);I(j==_n(gv),_q(gv,xn>1?aa0():au))A*p=(A*)_V(gv)+j;i(xn-1,P(!stp(i,x,&p),(A*)0))x(0);p)
